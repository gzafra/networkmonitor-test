...
public struct LoadImage: Reducer {
    ...
    public struct State: Equatable {
        public var networkState: NetworkState<LoadedImage, LoadImage.Error>
        
        public init(networkState: NetworkState<LoadedImage, LoadImage.Error>) {
...
extension LoadImage {
    fileprivate func loadEffect() -> Effect<LoadImage.Action> {
        return .run { send in
